...
const Admin_view_semesters_of_a_curriculum = () => {
  ...
  const semesters = [
    { semester_no: 1, start_semester: '2023-08-01', end_semester: '2023-12-15', instigate_semester: true },
    { semester_no: 2, start_semester: '2024-01-10', end_semester: '2024-05-15', instigate_semester: false },
    { semester_no: 3, start_semester: null, end_semester: null, instigate_semester: false },
    { semester_no: 4, start_semester: null, end_semester: null, instigate_semester: false },
    { semester_no: 5, start_semester: '2023-08-01', end_semester: '2023-12-15', instigate_semester: true },
    { semester_no: 6, start_semester: '2024-01-10', end_semester: '2024-05-15', instigate_semester: false },
    { semester_no: 7, start_semester: null, end_semester: null, instigate_semester: false },
    { semester_no: 8, start_semester: null, end_semester: null, instigate_semester: false },
  ];

  const semester_slots = [
    [
      { name: 'Slot A', courses: [{ name: 'Mathematics', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: 'Slot B', courses: [{ name: 'Physics', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: 'Slot A', courses: [{ name: 'Chemistry', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: '', courses: [] }, // Empty slot example
    ],
    [
      { name: 'Slot A', courses: [{ name: 'Chemistry', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: 'Slot B', courses: [{ name: 'Chemistry', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: 'Slot A', courses: [{ name: 'Chemistry', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: 'Slot C', courses: [{ name: 'Electronics', lecture_hours: 3, tutorial_hours: 1, credit: 4 }] },
      { name: '', courses: [] },
      { name: '', courses: [] },
    ],
    [
    ...
    <div style={{ position: 'relative' }}>
      ...
      >
        <div className="dropdown-section">
          ...
          >
            <button className="add-instigate-semester-button">INSTIGATE SEMESTER</button>
          ...
          >
            <button className="add-course-slot-button">ADD COURSE SLOT</button>
      ...
      >
        <thead>
          <tr style={{ border: '1px solid black' }}>
            ...
            <td colSpan={curriculum.no_of_semester} style={{ border: '1px solid black' }}>
          ...
          <tr style={{ border: '1px solid black' }}>
            ...
            {semesters.map((semester, index) => (
              <td key={index} style={{ border: '1px solid black' }}><strong style={{ color: 'blue', fontSize: '0.85vw' }}>Semester {semester.semester_no}</strong></td>
            ))}
          </tr>
        </thead>
        <tbody>
            ...
            <tr key={slotIndex} style={{ border: '1px solid black' }}>
              ...
              {semesters.map((semester, index) => (
                <td key={index} style={{ border: '1px solid black' }}>
                  {slotRow[index] && slotRow[index].name && slotRow[index].courses.length ? (
                    <div>
                      {slotRow[index].courses.map((course, courseIndex) => (
                        <p key={courseIndex}>
                          <strong style={{ fontSize: '0.65vw' }}>{course.name}</strong> <br />
          ...
          <tr style={{ border: '1px solid black' }}>
            <td style={{ border: '1px solid black' }}><strong style={{ color: 'blue', fontSize: '0.75vw' }}>Start Date</strong></td>
            {semesters.map((semester, index) => (
              <td key={index} style={{ border: '1px solid black' }}>
          ...
          <tr style={{ border: '1px solid black' }}>
            <td style={{ border: '1px solid black' }}><strong style={{ color: 'blue', fontSize: '0.75vw' }}>End Date</strong></td>
            {semesters.map((semester, index) => (
              <td key={index} style={{ border: '1px solid black' }}>
          ...
          <tr style={{ border: '1px solid black' }}>
            <td style={{ border: '1px solid black' }}><strong style={{ color: 'blue', fontSize: '0.75vw' }}>Total Credits</strong></td>
            {semester_credits.map((totalCredits, index) => (
              <td key={index} style={{ border: '1px solid black' }}>{totalCredits}</td>
            ))}
          </tr>
          <tr style={{ border: '1px solid black', padding: '0.75vw 45%' }}>
            <td style={{ border: '1px solid black' }}><strong style={{ color: 'blue', fontSize: '0.75vw' }}>Instigated</strong></td>
            {semesters.map((semester, index) => (
              <td key={index} style={{ border: '1px solid black' }}>
                {semester.instigate_semester ? (
                  <div style={{ color: 'green' }}>
                    <i className="icon checkmark"></i> Yes
                  </div>
                ) : (
                  <div style={{ color: 'red' }}>
                    <i className="attention icon"></i> Not Yet
                  </div>
                )}
              </td>
            ))}
